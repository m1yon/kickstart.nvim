...
now(function()
	if vim.fn.has("nvim-0.9") == 1 then
		...
		_G.statuscolumn = function()
			...
			if not vim.wo.number and vim.wo.signcolumn == "no" and vim.wo.foldcolumn == "0" then
				return ""
			end
...
_G.detect_bigline = function(threshold)
	...
	while cur_line > 0 do
		...
		if test_line == cur_line and #vim.fn.getline(test_line) >= threshold then
			return cur_line
		end
